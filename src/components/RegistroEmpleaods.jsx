...
function RegistroEmpleaods() {
  ...
  return (
    ...
    <div className='formulario-original' id='formulario-original'>
          <h1 className='text-center'>FORMULARIO DE GESTION DE EMPLEADOS</h1>
          <label class="form-label form-label-sm h4">CLAVE DEL EMPLEADO DE FARMACIA</label>
          <input type="text" id="matricula" name="matricula" className="form-control" value={inputValue2} onChange={handleInputChange2}/>
          <br />
          <br />
          <label class="form-label form-label-sm h4">NOMBRE DEL EMPLEADO DE FARMACIA</label>
          <input type="text" id="name" name="name" className="form-control" value={inputValue} onChange={handleInputChange}/>
          <br />
          <br />
          <label class="form-label form-label-sm h4">ROL QUE TIENE EN LA FARMACIA</label>
          <br />
