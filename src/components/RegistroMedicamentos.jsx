  ...
  return (
    <>
      <div className="formulario-original" id="formulario-original">
        <h1 className="text-center">FORMULARIO DE GESTION DE MEDICAMENTOS</h1>
        <label class="form-label form-label-sm h4">CLAVE DEL MEDICAMENTO</label>
        ...
        <div class="row g-7">
          <div class="col-auto">
            <label class="form-label form-label-sm h4">CATEGORIA DEL MEDICAMENTO</label>
            <br />
